						...
						<div class="box-body">
							...
							<?php echo validation_errors(); ?>
								...
								<div class="form-group">
									...
									<div class="error" id="password_error"><?php echo form_error('sortDesc')?></div>
								</div>
								<div class="form-group">
									<label>Chi tiết sản phẩm</label>
									<textarea name="detail" id="detail" class="form-control" ></textarea>
      								<script>CKEDITOR.replace('detail');</script>
									<div class="error" id="password_error"><?php echo form_error('detail')?></div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
								...
								<div class="error" id="password_error"><?php echo form_error('price_root')?></div>
								<div class="form-group">
									<label>Khuyến mãi (%)</label>
									<input name="sale_of" class="form-control" type="number">
								<div class="error" id="password_error"><?php echo form_error('sale_of')?></div>
								</div>
								<div class="form-group">
									<label>Giá bán</label>
								...
								<div class="error" id="password_error"><?php echo form_error('image_list[]')?></div>
								</div>
								<div class="form-group">
